...
#              Bug Fix #3: Previously this file was never read by any module.
#              All modules now reference $script:LicenseSkuMap and
#              $script:LicenseDefenderMap instead of defining their own copies.
# ================================================================================
...
# ---- Service Plan Name -> Defender Solution (supports wildcard keys) -----------
...
Write-Verbose "LicenseMap data loaded: $($script:LicenseSkuMap.Count) SKUs, $($script:LicenseDefenderMap.Count) Defender plans"
